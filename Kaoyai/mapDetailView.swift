...
class mapDetailView:UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        print("How to det: " + String(howToDet))
        print("HowtoDet size " + String(howToDet.count))
        print("content: " + String(self.contentString))
        print("topic: " + String(self.topicS))
        print("img path: " + String(self.imgPath))
...
//        let url = NSURL(string: String(self.imgPath))
        ...
        self.tableView = UITableView(frame: CGRectMake(0, 0, UIScreen.mainScreen().bounds.size.width+8, UIScreen.mainScreen().bounds.size.height-self.imgV.frame.size.height), style: UITableViewStyle.Plain)
